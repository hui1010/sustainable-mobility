      ...
      <div className="intro-container">
        <div className="intro-text">
          ...
          <p>
            ...
            sources
            <a
              href="https://ourworldindata.org/co2-emissions-from-transport"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="result-container">
              ...
              {distance * fuelArr[fuel] === 0 ? (
                ...
                <div className="result-numbers">
                  ...
                  <p>
                    ...
                    <b>
                      <i>
                        {((fuelArr[fuel] * distance * 0.038) / 1000).toFixed(2)}{" "}
                      </i>
                    </b>
          ...
          <div className="tips">
            ...
            <div className="tip">
              <p>Public transport</p>
              <div>
                Trains are nearly always the winning option over
            ...
            <div className="tip">
              <p>International traveling</p>
              <div>
                If it’s a choice between driving or flying internationally,
                flying economy class is often better.
              </div>
            </div>
            <div className="tip">
